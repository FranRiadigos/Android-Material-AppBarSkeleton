...
public class AppBarExtendedActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_appbar_extended);
        initToolbar();
        setupMainContent();
        initDropDownAdapter();
    }
    ...
    private void initDropDownAdapter() {
        ...
        appbarFilter.setSelection(Constants.AppBarStyles.EXTENDED);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_appbar_extended, menu);
        return true;
    }
